        ...
        <div className="flex flex-col gap-4 p-4 my-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-2 text-sm text-slate-500">
              ...
              <div>
                <p>
                می‌توانید عبارات را ویرایش کنید اما توجه داشته باشید که ویرایش شما، اعتبارسنجی نخواهد شد.
                پیشنهاد می‌شود عبارات ویرایش شده را به بخش «متن ورودی» منتقل کنید تا دوباره مورد ارزیابی قرار گیرند.
                </p>
              </div>
            </div>
          </div>
